...
**Тема:** kanbaNice — корпоративная система управления проектами по методологии Kanban
...
> **Примечание по оформлению:** при переносе в Word установите шрифт **Times New Roman 14 пт**, межстрочный интервал **1,5**, поля: левое 30 мм, правое 15 мм, верхнее и нижнее 20 мм. Нумерация страниц — с «Введения». Диаграммы вставляйте из каталога `kanbaNice/docs/images/`.
...
> **Примечание:** на момент подготовки отчёта часть тестов требует исправления импортов пакета `Repository` → `repository`.
...
Система развёртывается через **Docker Compose** — оркестрация четырёх сервисов.
...
1. Методические указания по выполнению курсового проекта (траектория Enterprise).
2. Гамма Э. и др. Приёмы объектно-ориентированного проектирования. — СПб.: Питер, 2021.
...
10. JavaFX Documentation. — https://openjfx.io/
